...
%    \begin{itemize}    
%    \item Dolev-Yao threat model represents the most powerful attacker possible
%    
%    \item However, this powerful attacker is not realistic in certain scenarios
%    
%    \item Workarounds to protect agains unrealistic attacks may introduce security problems
%    
...
%    \begin{itemize}
%    \item Security protocols are sequence of interactions among entities designed to achieve a certain end.
%    
%    \begin{itemize}
%        \item Goals are (not limited to):
%        \begin{itemize}
%            \item Authentication, Key distribution, Secrecy, Anonymity, etc
%        \end{itemize}
%    \end{itemize}
%    
%    \item Ceremonies include in addition to protocols:
%    
%    \begin{itemize}
%        \item new node types (humans, user interfaces, etc)
%        
%        \item new communication channels (human-device, human-human)
%        
%        \item additional operations which were previously out-of-bounds (user interaction, pre-key distribution)
%    \end{itemize}
%    \item In a protocol specification, we define assumptions to represent out-of-bound operations. 
%    
...
%    \begin{itemize}
%    \item A more human-centric security view.
%    
%    \item Designing more realistic ceremonies.
%    
%    \item Assist the human peer to assess the threat level he is subject to.
%    
